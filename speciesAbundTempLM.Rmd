...
If `sourceURL` is specified, `downloadData("speciesAbundTempLM", "C:/Users/Tati/Documents/GitHub")` may be sufficient.
...
df_inputs <- SpaDES.core::moduleInputs("speciesAbundTempLM", "C:/Users/Tati/Documents/GitHub")
...
Provide a summary of user-visible parameters (Table \@ref(tab:moduleParams-speciesAbundTempLM))


```{r moduleParams-speciesAbundTempLM, echo = FALSE, eval = TRUE, message = FALSE, warning = FALSE}
df_params <- SpaDES.core::moduleParams("speciesAbundTempLM", "C:/Users/Tati/Documents/GitHub")
...
df_outputs <- SpaDES.core::moduleOutputs("speciesAbundTempLM", "C:/Users/Tati/Documents/GitHub")
